<?php
    ...
    $conf['servers'][0]['pg_dump_path'] = '%dprogdir%\\modules\\database\\%pg_driver%\\bin\\pg_dump.exe';
    $conf['servers'][0]['pg_dumpall_path'] = '%dprogdir%\\modules\\database\\%pg_driver%\\bin\\pg_dumpall.exe';
